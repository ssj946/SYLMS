			...
			<div class="row">
				...
				<div class="col-10">
					...
					<div class= "card-header bg-navy bg-gradient text-white">
						<h5 class="d-inline ps-2"><i class="fas fa-clipboard-question  fa-lg mr-3"></i> 질문과 답변 </h5>
			        ...
			        <br>
						...
						<div class="page-navigation m-auto">
							...
							<div class="col-2"></div>
							<div class="col-8">
							<form name="searchForm" action="${pageContext.request.contextPath}/qna/qna.do" method="post">
							<div class="row">
								<div class="col-2 p-1">
							...
							<div class="row">
							<div class="col-2">
								<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/qna/qna.do?subjectNo=${subjectNo}';">새로고침</button>
							</div>
