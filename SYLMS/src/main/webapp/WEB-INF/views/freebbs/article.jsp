...
function deleteBoard() {
    if(confirm("게시글을 삭제 하시 겠습니까 ? ")) {
	    ...
	    let url = "${pageContext.request.contextPath}/freebbs/delete.do?" + query;
    	location.href = url;
    }
}
</c:if>
...
function listPage(page) {
	let url = "${pageContext.request.contextPath}/freebbs/listReply.do";
...
$(function(){
	$(".btnSendReply").click(function(){
		...
		let url = "${pageContext.request.contextPath}/freebbs/insertReply.do";
...
$(function(){
	$("body").on("click", ".deleteReply", function(){
		...
		let url = "${pageContext.request.contextPath}/freebbs/deleteReply.do";
...
$(function(){
	$("body").on("click", ".btnSendReplyLike", function(){
		...
		let url = "${pageContext.request.contextPath}/freebbs/insertReplyLike.do";
...
function listReplyAnswer(answer) {
	let url = "${pageContext.request.contextPath}/freebbs/listReplyAnswer.do";
...
function countReplyAnswer(answer) {
	let url = "${pageContext.request.contextPath}/freebbs/countReplyAnswer.do";
	let query = "answer=" + answer;
